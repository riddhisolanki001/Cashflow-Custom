...
def execute(filters=None):
	...
	net_change_in_cash = add_total_row_account(
		data, data, _("Net increase in cash and cash equivalents"), period_list, company_currency, summary_data, filters
	)
	net_change_in_cash = add_total_row_account(
		data, data, _("Opening Cash and Bank Balance"), period_list, company_currency, summary_data, filters
	)
	net_change_in_cash = add_total_row_account(
		data, data, _("Closing Cash and Bank Balance"), period_list, company_currency, summary_data, filters
	)
...
def get_cash_flow_accounts():
	operation_accounts = {
		...
		"account_types": [
			{"account_type": "Depreciation", "label": _("Net Profit After Tax")},
	...
	investing_accounts = {
		...
		"section_footer": _("Net Cash from Investing Activities"),
