...
def export():
    ...
    for attempt in range(max_retries):
        ...
        result = frappe.call(
            ...
            "general_ledger_customizations.api.trial_balance_sheet_data.get_trial_balance_sheet_prepared_data"
    ...
    xlsx_file = make_xlsx(rows, "Trial Balance")
    ...
    frappe.response["filename"] = "Trial Balance.xlsx"
